...
var Selector = /** @class */ (function (_super) {
    ...
    function Selector(props) {
        ...
        _this.onRandomExecute = _this.onRandomExecute.bind(_this);
        return _this;
    }
    /**
     ...
     */
    Selector.prototype.onRandomExecute = function () {
        var _this = this;
        console.log("DBG onRandomExecute");
        var _a = this.props, preloadRandom = _a.preloadRandom, rating = _a.rating;
        this.setState({
            isPending: true,
            searchError: null
        });
...
var GiphyClient = /** @class */ (function () {
     ...
     */
    GiphyClient.prototype.randomGifs = function (params) {
        return this.client.random("gifs", params).then(function (response) {
