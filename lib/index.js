...
var types_1 = __webpack_require__(7);
var GiphyClient_1 = __webpack_require__(16);
var QueryForm_1 = __webpack_require__(31);
var Suggestions_1 = __webpack_require__(35);
...
var Selector = /** @class */ (function (_super) {
    ...
    function Selector(props) {
        ...
        _this.onTrendingExecute = _this.onTrendingExecute.bind(_this);
        return _this;
    }
    /**
     ...
     */
    Selector.prototype.onTrendingExecute = function () {
        var _this = this;
        var _a = this.props, rating = _a.rating, limit = _a.limit;
        this.setState({
            isPending: true,
            searchError: null
        });
...
var GiphyJSClient = __webpack_require__(17);
var GiphyClient = /** @class */ (function () {
     ...
     * @param params ITrendingParams
     */
    GiphyClient.prototype.trendingGifs = function (params) {
        return this.client.trending("gifs", params).then(function (response) {
            return { gifObjects: response.data };
        });
    };
    return GiphyClient;
...
var React = __webpack_require__(0);
var cn = __webpack_require__(1);
var defaultStyle = __webpack_require__(32);
    ...
    QueryForm.prototype.render = function () {
        ...
        return (React.createElement("div", null,
            React.createElement("form", { style: queryFormStyle, className: cn(defaultStyle.queryForm, queryFormClassName), onSubmit: this.onSubmit },
                React.createElement("input", { style: queryFormInputStyle, className: cn(defaultStyle.queryFormInput, queryFormInputClassName), value: queryValue, type: "text", onChange: this.onValueChange, placeholder: queryInputPlaceholder, ref: this.inputRef }),
...
var React = __webpack_require__(0);
var cn = __webpack_require__(1);
var Suggestion_1 = __webpack_require__(36);
var defaultStyle = __webpack_require__(39);
...
var defaultStyle = __webpack_require__(45);
...
var SearchResult = /** @class */ (function (_super) {
    ...
    SearchResult.prototype.render = function () {
        ...
        var fixedWidth = gifObject.images.fixed_width, sourceImageUrl = fixedWidth.url || fixedWidth.gif_url;
